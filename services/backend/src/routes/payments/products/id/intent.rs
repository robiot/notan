...
pub async fn handler(
    ...
    // grab price for product
    let price = crate::utils::payments::products::get_product_price(
    ...
    let mut payment_intent_data = stripe::CreatePaymentIntent::new(price, stripe::Currency::EUR);
    ...
    // else use elements and save the card
        ...
        payment_intent_data.setup_future_usage = Some(stripe::PaymentIntentSetupFutureUsage::OffSession);
    }
